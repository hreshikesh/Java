...
<div class="container-fluid d-flex justify-content-center  align-items-center min-vh-100 ">
    <div class="border border-black border-3 rounded-3 p-4 text-center shadow-lg p-3 mb-5 bg-body-tertiary rounded  bg-warning-subtle text-warning-emphasis" data-bs-theme="dark">
