...
<nav class="navbar bg-body-tertiary justify-content-center align-items-center">
    <div class="container-fluid  ">
        <a class="navbar-brand fs-3  fw-bold align-items-center" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bus-front"
                 viewBox="0 0 16 16">
...
<div class="container-fluid d-flex justify-content-center align-items-center min-vh-100">
    <div class="container bg-white p-4 rounded shadow w-25">
        <span class="text-danger">${resultNotFound}</span>
        <form action="signin" method="get">
            <h3 class="text-center">BMTC SIGN-IN</h3>
            <div class="row mb-3">
                <div class="col-md-12">
