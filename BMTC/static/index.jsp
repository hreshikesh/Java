...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    <div class=" fs-3 fw-bold shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <h4 class="text-center">Signup/Signin</h4>
        <a href="SignUp.jsp" class="btn btn-primary" role="button">SignUp</a>
        <a href="Signin.jsp" class="btn btn-primary" role="button">SignIn</a>
    </div>
</div>
</body>
</html>